...
| `fleet` | Fleet claim/heartbeat/report projections and job lifecycle |
...
| `developmentEvidence` | metrics, configured reviews, tests, build provenance, reproducibility comparisons and gate status |
