 ...
 */
export const ADMIN_RESPONSE_KINDS_NOT_DECODED = ["generations_result", "metrics_result", "outbox_inspected", "outbox_reconciled", "reconciliation_failed", "reconciliation_inspected", "reload_status_result", "reload_succeeded", "status_result", "synthetic_accepted"] as const;
