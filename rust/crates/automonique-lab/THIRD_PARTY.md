...
| `autocfg` | 1.5.1 | transitive | `Apache-2.0 OR MIT` | crates.io registry |
| `bitflags` | 2.13.1 | transitive | `MIT OR Apache-2.0` | crates.io registry |
| `block-buffer` | 0.10.4 | transitive | `MIT OR Apache-2.0` | crates.io registry |
| `cc` | 1.4.0 | transitive | `MIT OR Apache-2.0` | crates.io registry |
| `cfg-if` | 1.0.4 | transitive | `MIT OR Apache-2.0` | crates.io registry |
| `cfg_aliases` | 0.2.1 | transitive | `MIT` | crates.io registry |
| `cpufeatures` | 0.2.17 | transitive | `MIT OR Apache-2.0` | crates.io registry |
| `crypto-common` | 0.1.7 | transitive | `MIT OR Apache-2.0` | crates.io registry |
| `digest` | 0.10.7 | transitive | `MIT OR Apache-2.0` | crates.io registry |
...
| `generic-array` | 0.14.7 | transitive | `MIT` | crates.io registry |
...
| `hex` | 0.4.3 | direct runtime | `MIT OR Apache-2.0` | crates.io registry |
...
| `memoffset` | 0.9.1 | transitive | `MIT` | crates.io registry |
| `nix` | 0.29.0 | direct runtime, features `fs`, `process`, `resource`, `signal`, `socket`, `user` | `MIT` | crates.io registry |
...
| `sha2` | 0.10.9 | direct runtime | `MIT OR Apache-2.0` | crates.io registry |
...
| `typenum` | 1.20.1 | transitive | `MIT OR Apache-2.0` | crates.io registry |
